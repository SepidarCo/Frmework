...
namespace Sepidar.Framework
{
    public class Unc : IDisposable
    {
        ...
        /// <param name="username">A user with sufficient rights to access the path.</param>
        ...
        public bool Connect(string uncPath, string username, string domain, string password)
        {
            sUNCPath = uncPath;
            sUser = username;
            sPassword = password;
